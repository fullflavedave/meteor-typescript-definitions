...
This package adds Meteor [TypeScript] (http://www.typescriptlang.org/) definitions to your project.  Definitions for the Meteor core library are current for Meteor version 0.9.0.
